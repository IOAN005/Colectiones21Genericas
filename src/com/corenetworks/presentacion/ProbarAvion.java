...
public class ProbarAvion {
    public static void main(String[] args) {
        Avion a1 =new Avion();
        //1Declarar una scanner
        //2 Pedir nombre dni en pasajero
        //3 Instanciar un pasajero
        //4 if-> ejecutivo ->asignar asiento ejecutivo sino asignarAsientoTurista
        //5 Tenemos que decir que asiento le coresponde
        ...
        System.out.println("escoja la clase \n 1)Ejecutivo \n 2) Turista \n");
        int clase=teclado.nextInt();
        if (clase==1){
            System.out.println("Escoja la ubication \n 1)Ventana \n 2) Pasillo \n");
        ...
        System.out.println("El asiento que le asignaron es ->" );
